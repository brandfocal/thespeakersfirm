...
const TICKER_IMAGES = {
  col1: ['https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1511578314322-379afb476865?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?q=80&w=600&auto=format&fit=crop'],
  col2: ['https://images.unsplash.com/photo-1505373877841-8d25f7d46678?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1528605248644-14dd04022da1?q=80&w=600&auto=format&fit=crop'],
  col3: ['https://images.unsplash.com/photo-1542744094-24638eff58bb?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1559223607-a43c990c692c?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1556761175-b413da4baf72?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?q=80&w=600&auto=format&fit=crop']
};
...
export const TheSpeakersFirmHome = () => {
  ...
  const tickerRotation = useTransform(scrollYProgress, [0, 1], [-18, -4]);
          ...
          <div className="relative isolate mt-14 sm:mt-20 md:mt-28">
            ...
            boxShadow: '0 0 260px 70px rgba(227, 14, 4, 0.08)'
              ...
              scale: tickerScale
                ...
                <div className="w-1/3"><TickerColumn images={TICKER_IMAGES.col1} direction="up" duration={18} parallaxRate={0.15} /></div>
                <div className="w-1/3"><TickerColumn images={TICKER_IMAGES.col2} direction="down" duration={24} parallaxRate={0.5} /></div>
                <div className="w-1/3"><TickerColumn images={TICKER_IMAGES.col3} direction="up" duration={14} parallaxRate={0.9} /></div>
              </motion.div>
