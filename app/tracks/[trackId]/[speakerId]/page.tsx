...
import { AboutTeamSection as MandisaZavalaProfile } from "@/components/generated/MandisaZavalaProfileNew";
import { AboutTeamSection as BusiSeleshoProfile } from "@/components/generated/BusiSeleshoProfileNew";
import { AboutTeamSection as EuniceSibiyaProfile } from "@/components/generated/EuniceSibiyaProfileNew";
import { AboutTeamSection as MaxMoyoProfile } from "@/components/generated/MaxMoyoProfileNew";
import { AboutTeamSection as NdumiHadebeProfile } from "@/components/generated/NdumiHadebeProfileNew";
import { AboutTeamSection as NkatekoKhozaProfile } from "@/components/generated/NkatekoKhozaProfileNew";
import { AboutTeamSection as SamkeMhlongoProfile } from "@/components/generated/SamkeMhlongoProfileNew";
import { AboutTeamSection as MlamuliMbamboProfile } from "@/components/generated/MlamuliMbamboProfileNew";
import { AboutTeamSection as ZolaMbathaProfile } from "@/components/generated/ZolaMbathaProfileNew";
import { AboutTeamSection as IsraelNokoProfile } from "@/components/generated/IsraelNokoProfileNew";
import { AboutTeamSection as ViweTiniProfile } from "@/components/generated/ViweTiniProfileNew";
import { AboutTeamSection as TebogoEdwardLeroleProfile } from "@/components/generated/TebogoEdwardLeroleProfileNew";
import { AboutTeamSection as ThatoTTMbhaProfile } from "@/components/generated/ThatoTTMbhaProfileNew";
import { AboutTeamSection as ApostleKabeloJMorokeProfile } from "@/components/generated/ApostleKabeloJMorokeProfileNew";
import { AboutTeamSection as MartinPeldersProfile } from "@/components/generated/MartinPeldersProfileNew";
import { AboutTeamSection as ProfessorKopanoRateleProfile } from "@/components/generated/ProfessorKopanoRateleProfileNew";
import { AboutTeamSection as MbuleloDyasiProfile } from "@/components/generated/MbuleloDyasiProfileNew";
import { AboutTeamSection as DrGugulethuXabaProfile } from "@/components/generated/DrGugulethuXabaProfileNew";
import { AboutTeamSection as LeratoMakhethaProfile } from "@/components/generated/LeratoMakhethaProfileNew";
import { AboutTeamSection as BafanaKhumaloProfile } from "@/components/generated/BafanaKhumaloProfileNew";
import { AboutTeamSection as DrAneleSiswanaProfile } from "@/components/generated/DrAneleSiswanaProfileNew";
import { AboutTeamSection as DrJerryGuleProfile } from "@/components/generated/DrJerryGuleProfileNew";
import { AboutTeamSection as JoshuaMakukuleMtanyelwaProfile } from "@/components/generated/JoshuaMakukuleMtanyelwaProfileNew";
import { AboutTeamSection as BonganiLuvaloProfile } from "@/components/generated/BonganiLuvaloProfileNew";
import { AboutTeamSection as SelloMaakeKaNcubeProfile } from "@/components/generated/SelloMaakeKaNcubeProfileNew";
import { AboutTeamSection as CaesarMolebatsiProfile } from "@/components/generated/CaesarMolebatsiProfileNew";
import { AboutTeamSection as DrShimmyKotuProfile } from "@/components/generated/DrShimmyKotuProfileNew";
import { AboutTeamSection as DrStevenMolakengProfile } from "@/components/generated/DrStevenMolakengProfileNew";
import { AboutTeamSection as LindaYendeProfile } from "@/components/generated/LindaYendeProfileNew";
import { AboutTeamSection as TumishoMashaProfile } from "@/components/generated/TumishoMashaProfileNew";
import { AboutTeamSection as MaryBomelaProfile } from "@/components/generated/MaryBomelaProfileNew";
import { AboutTeamSection as ZiphoSikhakhaneProfile } from "@/components/generated/ZiphoSikhakhaneProfileNew";
import { AboutTeamSection as YolisaKaniProfile } from "@/components/generated/YolisaKaniProfileNew";
import { AboutTeamSection as OfentsePitseProfile } from "@/components/generated/OfentsePitseProfileNew";
import { AboutTeamSection as LindaMaqomaProfile } from "@/components/generated/LindaMaqomaProfileNew";
import { AboutTeamSection as RikkyMinyukuProfile } from "@/components/generated/RikkyMinyukuProfileNew";
import { AboutTeamSection as BrianMhlangaProfile } from "@/components/generated/BrianMhlangaProfileNew";
...
import { AboutTeamSection as PaulinaMamogoboProfile } from "@/components/generated/PaulinaMamogoboProfileNew";
import { AboutTeamSection as LalaTukuProfile } from "@/components/generated/LalaTukuProfileNew";
import { AboutTeamSection as LiopeloMaphatheProfile } from "@/components/generated/LiopeloMaphatheProfileNew";
import { AboutTeamSection as FeliciaMabuzaSuttleProfile } from "@/components/generated/FeliciaMabuzaSuttleProfileNew";
import { AboutTeamSection as TebogoMekgoeProfile } from "@/components/generated/TebogoMekgoeProfileNew";
import { AboutTeamSection as AubreyMasangoProfile } from "@/components/generated/AubreyMasangoProfileNew";
import { AboutTeamSection as BridgetMasingaProfile } from "@/components/generated/BridgetMasingaProfileNew";
import { AboutTeamSection as DrBrendaKubhekaProfile } from "@/components/generated/DrBrendaKubhekaProfileNew";
import { AboutTeamSection as DrJohnKaniProfile } from "@/components/generated/DrJohnKaniProfileNew";
import { AboutTeamSection as DrMaureenTongProfile } from "@/components/generated/DrMaureenTongProfileNew";
import { AboutTeamSection as DuduMsomiProfile } from "@/components/generated/DuduMsomiProfileNew";
import { AboutTeamSection as JosinaMachelProfile } from "@/components/generated/JosinaMachelProfileNew";
import { AboutTeamSection as MusaSonoProfile } from "@/components/generated/MusaSonoProfileNew";
import { AboutTeamSection as MbuyiseloBothaProfile } from "@/components/generated/MbuyiseloBothaProfileNew";
import { AboutTeamSection as NdilekaMandelaProfile } from "@/components/generated/NdilekaMandelaProfileNew";
import { AboutTeamSection as NoniKhumaloProfile } from "@/components/generated/NoniKhumaloProfileNew";
import { AboutTeamSection as PeterNdoroProfile } from "@/components/generated/PeterNdoroProfileNew";
import { AboutTeamSection as PhemeloMoteneProfile } from "@/components/generated/PhemeloMoteneProfileNew";
import { AboutTeamSection as ProfMazweMajolaProfile } from "@/components/generated/ProfMazweMajolaProfileNew";
import { AboutTeamSection as SidPeimerProfile } from "@/components/generated/SidPeimerProfileNew";
import { AboutTeamSection as SibusisoMolimiProfile } from "@/components/generated/SibusisoMolimiProfileNew";
...
export default async function SpeakerPage({ params }: PageProps) {
  ...
  if (speakerId === "zingisa-motloba" || speakerId === "zingisa-nozuko-motloba") {
    return <ZingisaMotlobaProfile />;
  }
  ...
  if (speakerId === "mandisa-zavala") {
    return <MandisaZavalaProfile />;
  }

  if (speakerId === "busi-selesho") {
    return <BusiSeleshoProfile />;
  }

  if (speakerId === "eunice-sibiya") {
    return <EuniceSibiyaProfile />;
  }

  if (speakerId === "max-moyo") {
    return <MaxMoyoProfile />;
  }

  if (speakerId === "ndumi-hadebe") {
    return <NdumiHadebeProfile />;
  }

  if (speakerId === "nkateko-khoza") {
    return <NkatekoKhozaProfile />;
  }

  if (speakerId === "samke-mhlongo" || speakerId === "samke-mhlongo-2") {
    return <SamkeMhlongoProfile />;
  }

  if (speakerId === "mlamuli-mbambo") {
    return <MlamuliMbamboProfile />;
  }

  if (speakerId === "zola-mbatha") {
    return <ZolaMbathaProfile />;
  }

  if (speakerId === "israel-noko") {
    return <IsraelNokoProfile />;
  }

  if (speakerId === "viwe-tini") {
    return <ViweTiniProfile />;
  }

  if (speakerId === "tebogo-edward-lerole") {
    return <TebogoEdwardLeroleProfile />;
  }

  if (speakerId === "thato-tt-mbha") {
    return <ThatoTTMbhaProfile />;
  }

  if (speakerId === "apostle-kabelo-j-moroke" || speakerId === "apostle-kabelo-moroke") {
    return <ApostleKabeloJMorokeProfile />;
  }

  if (speakerId === "martin-pelders") {
    return <MartinPeldersProfile />;
  }

  if (speakerId === "professor-kopano-ratele" || speakerId === "kopano-ratele") {
    return <ProfessorKopanoRateleProfile />;
  }

  if (speakerId === "mbulelo-dyasi") {
    return <MbuleloDyasiProfile />;
  }

  if (speakerId === "dr-gugulethu-xaba" || speakerId === "gugulethu-xaba") {
    return <DrGugulethuXabaProfile />;
  }

  if (speakerId === "lerato-makhetha") {
    return <LeratoMakhethaProfile />;
  }

  if (speakerId === "bafana-khumalo") {
    return <BafanaKhumaloProfile />;
  }

  if (speakerId === "dr-anele-siswana" || speakerId === "dr-anele-siswana-2") {
    return <DrAneleSiswanaProfile />;
  }

  if (speakerId === "dr-jerry-gule") {
    return <DrJerryGuleProfile />;
  }

  if (speakerId === "joshua-makukule-mtanyelwa") {
    return <JoshuaMakukuleMtanyelwaProfile />;
  }

  if (speakerId === "bongani-luvalo") {
    return <BonganiLuvaloProfile />;
  }

  if (speakerId === "sello-maake-ka-ncube") {
    return <SelloMaakeKaNcubeProfile />;
  }

  if (speakerId === "caesar-molebatsi") {
    return <CaesarMolebatsiProfile />;
  }

  if (speakerId === "dr-shimmy-kotu" || speakerId === "shimmy-kotu") {
    return <DrShimmyKotuProfile />;
  }

  if (speakerId === "dr-steven-molakeng" || speakerId === "steven-molakeng") {
    return <DrStevenMolakengProfile />;
  }

  if (speakerId === "linda-yende") {
    return <LindaYendeProfile />;
  }

  if (speakerId === "rikky-minyuku") {
    return <RikkyMinyukuProfile />;
  }

  if (speakerId === "brian-mhlanga") {
    return <BrianMhlangaProfile />;
  }

  if (speakerId === "mbuso-khoza") {
    return <MbusoKhozaProfile />;
  }

  if (speakerId === "gcina-mhlophe-becker" || speakerId === "gcina-mhlophe") {
    return <GcinaMhlopheBeckerProfile />;
  }
  ...
  if (speakerId === "dr-paulina-mamogobo" || speakerId === "dr-paulina-mamogobo-2") {
    return <PaulinaMamogoboProfile />;
  }

  if (speakerId === "lala-tuku") {
    return <LalaTukuProfile />;
  }

  if (speakerId === "liopelo-maphathe") {
    return <LiopeloMaphatheProfile />;
  }

  if (speakerId === "felicia-mabuza-suttle") {
    return <FeliciaMabuzaSuttleProfile />;
  }

  if (speakerId === "tebogo-mekgoe") {
    return <TebogoMekgoeProfile />;
  }

  if (speakerId === "aubrey-masango" || speakerId === "aubrey-masango-mc") {
    return <AubreyMasangoProfile />;
  }

  if (speakerId === "bridget-masinga" || speakerId === "bridget-masinga-mc") {
    return <BridgetMasingaProfile />;
  }

  if (speakerId === "dr-brenda-kubheka" || speakerId === "brenda-kubheka") {
    return <DrBrendaKubhekaProfile />;
  }

  if (speakerId === "dr-john-kani" || speakerId === "john-kani" || speakerId === "dr-john-kani-ois-obe") {
    return <DrJohnKaniProfile />;
  }

  if (speakerId === "dr-maureen-tong" || speakerId === "maureen-tong") {
    return <DrMaureenTongProfile />;
  }

  if (speakerId === "dudu-msomi") {
    return <DuduMsomiProfile />;
  }

  if (speakerId === "josina-machel" || speakerId === "josina-z-machel") {
    return <JosinaMachelProfile />;
  }

  if (speakerId === "musa-sono") {
    return <MusaSonoProfile />;
  }

  if (speakerId === "mbuyiselo-botha") {
    return <MbuyiseloBothaProfile />;
  }

  if (speakerId === "ndileka-mandela") {
    return <NdilekaMandelaProfile />;
  }

  if (speakerId === "noni-khumalo" || speakerId === "nonhlanhla-noni-khumalo") {
    return <NoniKhumaloProfile />;
  }

  if (speakerId === "peter-ndoro") {
    return <PeterNdoroProfile />;
  }

  if (speakerId === "phemelo-motene") {
    return <PhemeloMoteneProfile />;
  }

  if (speakerId === "mazwe-majola" || speakerId === "prof-mazwe-majola") {
    return <ProfMazweMajolaProfile />;
  }

  if (speakerId === "sid-peimer") {
    return <SidPeimerProfile />;
  }

  if (speakerId === "sibusiso-molimi") {
    return <SibusisoMolimiProfile />;
  }

  if (speakerId === "pastor-tebogo-moema" || speakerId === "tebogo-moema") {
    return <PastorTebogoMoemaProfile />;
  }

  if (speakerId === "pumela-salela" || speakerId === "dr-pumela-salela") {
    return <PumelaSalelaProfile />;
  }

  if (speakerId === "jabulile-khumalo") {
    return <JabulileKhumaloProfile />;
  }

  if (speakerId === "ntsoaki-sibiya") {
    return <NtsoakiSibiyaProfile />;
  }
  ...
  if (speakerId === "tumisho-masha") {
    return <TumishoMashaProfile />;
  }

  if (speakerId === "mary-bomela") {
    return <MaryBomelaProfile />;
  }

  if (speakerId === "zipho-sikhakhane") {
    return <ZiphoSikhakhaneProfile />;
  }

  if (speakerId === "yolisa-kani") {
    return <YolisaKaniProfile />;
  }

  if (speakerId === "ofentse-pitse") {
    return <OfentsePitseProfile />;
  }

  if (speakerId === "linda-maqoma") {
    return <LindaMaqomaProfile />;
  }
  ...
  if (speakerId === "pitika-ntuli" || speakerId === "prof-pitika-ntuli") {
    return <PitikaProfile />;
  }
  ...
  if (speakerId === "rehema-isa") {
    return <RehemaIsaProfile />;
  }
