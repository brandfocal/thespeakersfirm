...
export function Footer() {
  return (
    <footer className="relative w-full border-t bg-[#111111] border-[#333333] text-[#AAAAAA]">
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 pt-20 pb-0 sm:pt-24 md:pt-28 relative z-10">
        <div className="grid grid-cols-1 gap-14 md:grid-cols-12 md:gap-8 pb-10 md:pb-12">
          ...
          <nav className="md:col-span-3" aria-label="Footer navigation">
            <h3 className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#777777]">
              Navigate
            </h3>
          ...
          <div className="md:col-span-4 md:text-right flex flex-col gap-3 md:items-end">
            <h3 className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#777777] self-start md:self-auto">
              Contact
            </h3>
            <div className="mt-2 flex flex-col items-start gap-3 md:items-end w-full">
              ...
              <div className="mt-3 flex items-center gap-4 md:justify-end" aria-label="Social media links">
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-[#AAAAAA] transition-colors duration-300 hover:text-[#e30e04]">
                ...
                <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-[#AAAAAA] transition-colors duration-300 hover:text-[#e30e04]">
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="h-5 w-5 fill-current">
                ...
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-[#AAAAAA] transition-colors duration-300 hover:text-[#e30e04]">
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="h-5 w-5 fill-current">
        ...
        {/* Bottom copyright */}
        <div className="mx-[-24px] mt-20 border-t border-[#333333] px-6 py-6 md:mx-[-64px] md:px-16 bg-[#0A0A0A]">
          <p className="font-mono text-[11px] uppercase tracking-[0.1em] text-[#777777]">
