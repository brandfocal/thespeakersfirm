...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Dr Anele Siswana through The Speakers Firm, A Leading African Speakers Bureau, to bring decolonial psychology masterclasses, cultural intelligence briefings, and positive masculinity keynotes to your next event or boardroom."
];
