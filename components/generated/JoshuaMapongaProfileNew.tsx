...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Joshua Maponga through The Speakers Firm, A Leading African Speakers Bureau, to bring Pan-African philosophy, strategic consciousness lectures, and social change insights to your next corporate or community event."
];
