...
const SPEAKER_GALLERY_IMAGES: GalleryImage[] = [
  {
    id: "bonang-mohale-profile-portrait",
    src: "/speakers/Bonang Mohale/bonang-mohale.jpg",
    alt: "Professor Bonang Mohale portrait"
  },
  {
    id: "bonang-mohale-gallery-six",
    src: "/speakers/Bonang Mohale/bonang-mohale-sixth.jpg",
    alt: "Professor Bonang Mohale speaking engagement"
  },
  {
    id: "bonang-mohale-gallery-seven",
    src: "/speakers/Bonang Mohale/bonang-mohale-seventh.jpg",
    alt: "Professor Bonang Mohale panel discussion"
  },
  {
    id: "bonang-mohale-gallery-eight",
    src: "/speakers/Bonang Mohale/bonang-mohale-eighth.jpg",
    alt: "Professor Bonang Mohale boardroom intervention"
  }
];

const REPEATED_GALLERY_IMAGES: RepeatedGalleryImage[] = [
...
export const CallToActionSection = () => {
  ...
  return (
    <section className="relative flex min-h-[620px] w-full items-center justify-center overflow-hidden bg-[#F2F2F2] p-4 sm:p-6 md:p-12" aria-labelledby="premium-cta-heading">
      <div className="relative grid w-full max-w-7xl grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2">
        ...
        <article className="group relative h-[340px] overflow-hidden rounded-[24px] bg-[#212121] shadow-2xl sm:h-[400px] md:rounded-[32px] lg:h-[450px]" aria-label="Scrolling speaker and conference photo gallery">
          ...
          >
            {REPEATED_GALLERY_IMAGES.map(image => (
              <img 
                key={image.repeatId} 
                src={image.src} 
                alt={image.alt} 
                className="h-[280px] w-[178px] max-w-full flex-shrink-0 rounded-2xl object-cover shadow-lg sm:h-[340px] sm:w-[214px] lg:h-[380px] lg:w-[240px]" 
                loading="lazy" 
              />
            ))}
          </motion.div>
          ...
          >
            ...
            <div className="mt-6 flex w-full flex-col gap-3 sm:flex-row sm:gap-4">
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }} 
                className="flex h-[52px] w-full items-center justify-between gap-4 rounded-full bg-[#e30e04] px-6 text-[11px] font-bold uppercase tracking-[0.1em] text-white transition-opacity duration-300 hover:opacity-90 sm:h-[56px] sm:px-8 sm:text-[12px] md:w-auto" 
                type="button" 
              ...
              <button 
                className="flex h-[52px] w-full items-center justify-center gap-3 rounded-full border border-[#212121] bg-transparent px-6 text-[11px] font-bold uppercase tracking-[0.1em] text-[#212121] transition-colors duration-200 hover:bg-[#212121] hover:text-white sm:h-[56px] sm:px-8 sm:text-[12px] md:w-auto" 
                type="button" 
                aria-label="Book a call" 
                onClick={() => scrollToSection("booking-calendar")}
              >
