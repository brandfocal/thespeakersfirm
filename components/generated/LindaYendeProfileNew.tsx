...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Linda Yende through The Speakers Firm, A Leading African Speakers Bureau, to bring relationship expertise, youth development facilitation, and positive masculinity dialogues to your next corporate or community event."
];
