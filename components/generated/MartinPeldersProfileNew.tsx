...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Martin Pelders through The Speakers Firm, A Leading African Speakers Bureau, to bring definitive psychological safety workshops, leadership transformation talks, and men's mental health keynotes to your organization."
];
