  ...
  return <main className="min-h-screen w-full overflow-x-hidden" style={{
    ...
    fontFamily: 'Kontora, sans-serif'
      ...
      backgroundColor: COLORS.offWhite
        ...
        <div className="mx-auto max-w-[1440px] px-6 md:px-16"><SectionTag>FEATURED</SectionTag><Reveal><h2 className="mt-7 max-w-3xl text-3xl font-bold uppercase leading-[0.9] tracking-[-0.055em] text-[#000000] sm:text-4xl md:text-5xl lg:text-6xl">Where TSF Speakers Make News.</h2></Reveal>
