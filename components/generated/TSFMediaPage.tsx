...
export const TSFMediaPage = () => {
  return <main className="min-h-screen w-full overflow-x-hidden" style={{
    ...
    fontFamily: 'Kontora, sans-serif'
      ...
      <section className="relative py-12 sm:py-16 md:py-24 lg:py-32" style={{
      backgroundColor: COLORS.red
    }}><VerticalBorderLines isDark={true} /><div className="mx-auto flex max-w-[1440px] flex-col items-start justify-between gap-10 px-6 md:px-16 lg:flex-row lg:items-end"><Reveal><h2 className="max-w-4xl text-[clamp(2.5rem,8vw,7rem)] font-bold uppercase leading-[0.86] tracking-[-0.055em] text-white">Your Platform Deserves the Right Voice.</h2><p className="mt-8 max-w-md text-base text-white/75 md:text-lg">Let’s make the next conversation count.</p></Reveal><motion.a href="/contact" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="flex w-full items-center justify-center gap-2 rounded-full border bg-white p-1.5 sm:w-auto" style={{ borderColor: 'rgba(255, 255, 255, 0.18)' }}><span className="flex flex-1 items-center justify-center gap-3 rounded-full bg-[#000000] px-5 py-3 text-[12px] font-bold uppercase tracking-[0.1em] text-white sm:flex-none sm:px-10 sm:py-4 sm:text-[13px]"><span>Brief The Speakers Firm</span><ArrowUpRight size={16} /></span></motion.a></div></section>
    </main>;
};
