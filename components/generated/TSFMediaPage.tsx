    ...
    fontFamily: 'Kontora, sans-serif'
      ...
      backgroundColor: COLORS.black
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-10rem)] max-w-[1440px] flex-col justify-center px-6 md:px-16">
          ...
          duration: 0.6,
          delay: 0.3
        }} className="mb-6"><span className={SECTION_TAG_CLASS} style={SECTION_TAG_STYLE}>— MEDIA</span></motion.div>
      ...
      <section className="relative py-12 sm:py-16 md:py-24 lg:py-32" style={{
      backgroundColor: COLORS.red
    }}><VerticalBorderLines isDark={true} /><div className="mx-auto flex max-w-[1440px] flex-col items-start justify-between gap-10 px-6 md:px-16 lg:flex-row lg:items-end"><Reveal><h2 className="max-w-4xl text-[clamp(2.5rem,8vw,7rem)] font-bold uppercase leading-[0.86] tracking-[-0.055em] text-white">Your Platform Deserves the Right Voice.</h2><p className="mt-8 max-w-md text-base text-white/75 md:text-lg">Let’s make the next conversation count.</p></Reveal><a href="/#brief-us" className="w-full shrink-0 bg-[#000000] px-7 py-5 text-center text-xs font-black uppercase tracking-[0.14em] text-white transition-colors hover:bg-white hover:text-[#000000] sm:w-auto">Brief The Speakers Firm <ArrowUpRight className="ml-2 inline" size={15} /></a></div></section>
    </main>;
};
