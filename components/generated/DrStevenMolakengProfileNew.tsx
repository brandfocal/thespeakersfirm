...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Dr Steven Molakeng through The Speakers Firm, A Leading African Speakers Bureau, to bring music business insights, mental wellness workshops, and trauma counselling expertise to your next event or corporate program."
];
