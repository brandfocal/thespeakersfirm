...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Sello Maake Ka-Ncube through The Speakers Firm, Africa’s #1 Strategic Speakers Bureau, to bring inspirational keynote addresses, creative leadership masterclasses, and masculinity dialogues to your next corporate or community event."
];
