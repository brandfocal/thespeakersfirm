...
export const TSFAboutUsRedesign = () => {
  ...
  <section id="top" className="relative h-[100svh] min-h-[640px] w-full overflow-hidden sm:min-h-[720px] lg:h-[100vh] bg-black">
    <picture className="absolute inset-0 h-full w-full">
      <source media="(max-width: 767px)" srcSet="/hero_backgrounds/about-us-mobile.jpg" />
      <img src="/hero_backgrounds/about-us.jpg" alt="Audience gathered at a live event" className="h-full w-full object-cover object-center" />
    </picture>
