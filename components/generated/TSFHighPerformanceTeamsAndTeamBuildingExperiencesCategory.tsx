...
const speakers: Speaker[] = [
  ...
  },
  {
    ...
    "role": "Keynote Speaker, Author & Organisational Culture Specialist",
    "image": "/speaker_thumbnails/Dr-Billy-Selekane-The-Speakers-Firm.jpg",
    "topics": [
      "Strategic Team Alignment",
      "Building Trust & Execution Capacity"
    ],
    "path": "/tracks/inspirational-keynote-speakers/billy-selekane"
  }
];

const filterChips = [
  { id: 'all', label: 'All' },
  { id: 'topic-0', label: "Strategic Team Alignment" },
  { id: 'topic-1', label: "Accountability Frameworks" },
  { id: 'topic-2', label: "Experiential Group Interventions" },
  { id: 'topic-3', label: "Building Trust & Execution Capacity" }
];
...
export function TSFHighPerformanceTeamsAndTeamBuildingExperiencesCategory() {
    ...
    <main id="top" className="min-h-screen overflow-hidden bg-[#212121] text-[#f8f7f5] font-[Kontora,sans-serif] selection:bg-[#e30e04] selection:text-white">
      <section className="relative min-h-screen w-full overflow-hidden pt-20 pb-0 md:pb-28 md:pt-24 lg:pb-44 bg-[#000000]">
        <div className="absolute inset-0 z-0 bg-[#000000]" aria-hidden="true">
            ...
            <source media="(max-width: 767px)" srcSet="/hero_backgrounds/high-performance-mobile.jpg" />
            <img src="/speakers/Queen Ramotsehoa/Queen-Ramotsehoa-The-Speakers-Firm-8.jpg" alt="" className="h-full w-full object-cover object-center" />
          </picture>
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-10rem)] max-w-[1440px] flex-col justify-end pb-12 md:justify-center md:pb-0 px-6 md:px-16">
          ...
          <h1 className="text-[clamp(2.5rem,8vw,5.5rem)] font-bold uppercase leading-[0.95] tracking-[-0.055em] text-[#ffffff] drop-shadow-[0_8px_34px_rgba(0,0,0,0.38)] mt-6">
            ...
            <span className="text-[#e30e04]">TEAMS.</span>
          </h1>
          ...
          <div className="mt-8 flex max-w-[650px] flex-col gap-4">
            <p className="text-[16px] font-normal leading-[1.65] text-[#ffffff]/80 drop-shadow-[0_6px_22px_rgba(0,0,0,0.45)] md:text-[18px]">
              Transforming Groups Into Aligned, Accountable Units.
            </p>
            <p className="text-sm leading-6 text-white/60">
              Expert facilitators and coaches transforming groups into aligned, accountable and high-performing teams through powerful experiential interventions.
            </p>
          </div>
        </div>
      </section>
