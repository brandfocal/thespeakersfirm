...
const filterChips = [
  { id: 'all', label: 'All' },
  { id: 'topic-0', label: "Geopolitical Risk Analysis" },
  { id: 'topic-1', label: "Global Policy Shifts" },
  { id: 'topic-2', label: "International Diplomacy & Trade" },
  { id: 'topic-3', label: "The Evolving Global Order" }
];
...
export function TSFGeopoliticsPolicyAndGlobalAffairsCategory() {
    ...
    <main id="top" className="min-h-screen overflow-hidden bg-[#212121] text-[#f8f7f5] font-[Kontora,sans-serif] selection:bg-[#e30e04] selection:text-white">
      <section className="relative min-h-screen w-full overflow-hidden pt-20 pb-0 md:pb-28 md:pt-24 lg:pb-44 bg-[#000000]">
        <div className="absolute inset-0 z-0 bg-[#000000]" aria-hidden="true">
            ...
            <source media="(max-width: 767px)" srcSet="/hero_backgrounds/geopolitics-mobile.jpg" />
            <img src="/speakers/Thembisa Fakude/Thembisa-Fakude-The-Speakers-Firm-6.jpg" alt="" className="h-full w-full object-cover object-center" />
          </picture>
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-10rem)] max-w-[1440px] flex-col justify-end pb-12 md:justify-center md:pb-0 px-6 md:px-16">
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            <SectionTag>GEOPOLITICS & POLICY</SectionTag>
          </motion.div>
          ...
          <h1 className="text-[clamp(2.5rem,8vw,5.5rem)] font-bold uppercase leading-[0.95] tracking-[-0.055em] text-[#ffffff] drop-shadow-[0_8px_34px_rgba(0,0,0,0.38)] mt-6">
            <span>GEOPOLITICS &</span><br />
            <span className="text-[#e30e04]">POLICY.</span>
          </h1>
          ...
          <div className="mt-8 flex max-w-[650px] flex-col gap-4">
            <p className="text-[16px] font-normal leading-[1.65] text-[#ffffff]/80 drop-shadow-[0_6px_22px_rgba(0,0,0,0.45)] md:text-[18px]">
              Understanding Risk in the Evolving Global Order.
            </p>
            <p className="text-sm leading-6 text-white/60">
              Diplomats, political leaders, journalists and analysts helping decision-makers understand geopolitical risk, policy shifts and the evolving global order.
            </p>
          </div>
        </div>
      </section>
