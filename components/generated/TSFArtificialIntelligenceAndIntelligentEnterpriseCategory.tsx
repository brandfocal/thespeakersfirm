...
const speakers: Speaker[] = [
  {
    ...
    "path": "/tracks/digital-identity-cybersecurity-and-data-sovereignty/alistair-mokoena"
  },
  {
    "id": "sipho-maseko",
    "name": "Sipho Maseko",
  ...
  },
  {
    ...
    "path": "/tracks/digital-identity-cybersecurity-and-data-sovereignty/callan-abrahams"
  },
  {
    ...
    "path": "/tracks/digital-identity-cybersecurity-and-data-sovereignty/kgomotso-mamello-motshidi"
  },
  {
    ...
    "path": "/tracks/digital-identity-cybersecurity-and-data-sovereignty/puleng-mokhoalibe"
  },
  {
    "id": "tumi-ramonotsi",
    "name": "Tumi Ramonotsi",
  ...
  },
  {
    ...
    "path": "/tracks/digital-identity-cybersecurity-and-data-sovereignty/molefe-pooe"
  }
];

const filterChips = [
  { id: 'all', label: 'All' },
  { id: 'topic-0', label: "Responsible Enterprise AI Adoption" },
  { id: 'topic-1', label: "Measurable Commercial Value" },
  { id: 'topic-2', label: "AI Transformation Strategy" },
  { id: 'topic-3', label: "Intelligent Enterprise Architecture" }
];
...
export function TSFArtificialIntelligenceAndIntelligentEnterpriseCategory() {
    ...
    <main id="top" className="min-h-screen overflow-hidden bg-[#212121] text-[#f8f7f5] font-[Kontora,sans-serif] selection:bg-[#e30e04] selection:text-white">
      <section className="relative min-h-screen w-full overflow-hidden pt-20 pb-0 md:pb-28 md:pt-24 lg:pb-44 bg-[#000000]">
        <div className="absolute inset-0 z-0 bg-[#000000]" aria-hidden="true">
            ...
            <img src="/speakers/John Sanei/John-Sanei-The-Speakers-Firm-6.jpg" alt="" className="h-full w-full object-cover object-center" />
          </picture>
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-10rem)] max-w-[1440px] flex-col justify-end pb-12 md:justify-center md:pb-0 px-6 md:px-16">
          ...
          <div className="mt-8 flex max-w-[650px] flex-col gap-4">
            ...
            <p className="text-sm leading-6 text-white/60">
              Al pioneers and transformation leaders helping organisations move from experimentation to responsible, enterprise-wide adoption and measurable commercial value.
            </p>
          </div>
        </div>
      </section>
