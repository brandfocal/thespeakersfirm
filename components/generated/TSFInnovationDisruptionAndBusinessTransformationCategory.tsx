...
const filterChips = [
  { id: 'all', label: 'All' },
  { id: 'topic-0', label: "Challenging Established Business Models" },
  { id: 'topic-1', label: "Business & Operational Transformation" },
  { id: 'topic-2', label: "Building Future-Ready Enterprises" },
  { id: 'topic-3', label: "Unlocking New Commercial Value" }
];
...
export function TSFInnovationDisruptionAndBusinessTransformationCategory() {
    ...
    <main id="top" className="min-h-screen overflow-hidden bg-[#212121] text-[#f8f7f5] font-[Kontora,sans-serif] selection:bg-[#e30e04] selection:text-white">
      <section className="relative min-h-screen w-full overflow-hidden pt-20 pb-0 md:pb-28 md:pt-24 lg:pb-44 bg-[#000000]">
        <div className="absolute inset-0 z-0 bg-[#000000]" aria-hidden="true">
            ...
            <source media="(max-width: 767px)" srcSet="/hero_backgrounds/innovation-mobile.jpg" />
            <img src="/speakers/Stafford Masie/Stafford-Masie.jpg" alt="" className="h-full w-full object-cover object-center" />
          </picture>
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-10rem)] max-w-[1440px] flex-col justify-end pb-12 md:justify-center md:pb-0 px-6 md:px-16">
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            <SectionTag>INNOVATION & DISRUPTION</SectionTag>
          </motion.div>
          ...
          <div className="mt-8 flex max-w-[650px] flex-col gap-4">
            <p className="text-[16px] font-normal leading-[1.65] text-[#ffffff]/80 drop-shadow-[0_6px_22px_rgba(0,0,0,0.45)] md:text-[18px]">
              Unlocking New Value for Future-Ready Enterprises.
            </p>
            <p className="text-sm leading-6 text-white/60">
              Proven innovators equipping organisations to challenge established models, unlock new value and build future-ready enterprises.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-6 md:px-16">
          <blockquote className="m-0">
            ...
            <p className="mt-2 max-w-[800px] text-base italic leading-8 text-[#f8f7f5]/85 sm:text-lg">
              The talent secured by The Speakers Firm elevated our event, strengthened our brand positioning, and gave our audience ideas they could apply beyond the room. This was not simply a speaking engagement. It was a strategic investment in influence, reputation, and impact. Brief The Speakers Firm and turn your platform into a business asset.
            </p>
