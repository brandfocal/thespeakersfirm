...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Israel Noko through The Speakers Firm, A Leading African Speakers Bureau, to bring definitive B-BBEE transformation strategy, corporate governance insight, and inclusive growth frameworks to your next boardroom or conference."
];
