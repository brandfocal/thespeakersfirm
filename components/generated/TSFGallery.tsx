...
export const TSFGallery = () => {
  ...
  return <main className="min-h-screen bg-[#ffffff] font-[Kontora,sans-serif] text-[#212121]">
      ...
      <section id="contact" className="relative border-t border-[rgba(33,33,33,0.14)] py-16 md:py-24 lg:py-28 bg-[#e30e04]"><VerticalBorderLines /><motion.div {...reveal} className="mx-auto grid max-w-[1440px] gap-10 px-6 md:px-16 lg:grid-cols-12 lg:items-end"><div className="lg:col-span-8"><SectionTag>Media Enquiries</SectionTag><h2 className="mt-7 text-[clamp(3rem,13vw,7rem)] font-bold uppercase leading-[0.86] tracking-[-0.055em] text-white">Bring The Speakers Firm<br /><span className="text-white/80">to your stage.</span></h2><p className="mt-8 max-w-lg text-base leading-relaxed text-white/90">For press enquiries, event coverage, or to invite one of our speakers to your next gathering, our team would love to hear from you.</p></div><div className="flex flex-wrap gap-3 lg:col-span-4 lg:justify-end"><Link href="/brief-us" className="inline-flex items-center rounded-full bg-[#000000] px-5 py-3 text-[11px] font-bold uppercase tracking-[0.1em] text-white transition-all hover:bg-black/80">Brief Us Now <ArrowRight className="ml-2 h-4 w-4" /></Link><Link href="/contact" className="inline-flex items-center rounded-full border border-white/25 hover:border-white/50 backdrop-blur-sm px-5 py-3 text-[11px] font-bold uppercase tracking-[0.1em] text-white transition-all">Make An Enquiry</Link></div></motion.div></section>
