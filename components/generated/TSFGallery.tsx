  ...
  return <main className="min-h-screen bg-[#ffffff] font-[Kontora,sans-serif] text-[#212121]">
      ...
      backgroundColor: '#000000'
        ...
        <div className="absolute inset-0 z-0 bg-[#111111]" aria-hidden="true">
          <img src="/galleries/LeratoSithole-AfricaInsuranceConference2026/DSC_4598.JPG" alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover object-center" />
