...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Mandisa Zavala through The Speakers Firm, A Leading African Speakers Bureau, to bring strategic financial foresight and expert investment insights to your next corporate summit, board presentation, or economic advisory session."
];
