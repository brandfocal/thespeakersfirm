...
const filterChips = [
  { id: 'all', label: 'All' },
  { id: 'topic-0', label: "Technological Adaptation & Integration" },
  { id: 'topic-1', label: "Evolving Skill Requirements" },
  { id: 'topic-2', label: "Future Workplace Models" },
  { id: 'topic-3', label: "Workforce & Talent Transformation" }
];
...
export function TSFFutureOfWorkTalentAndWorkforceTransformationCategory() {
    ...
    <main id="top" className="min-h-screen overflow-hidden bg-[#212121] text-[#f8f7f5] font-[Kontora,sans-serif] selection:bg-[#e30e04] selection:text-white">
      <section className="relative min-h-screen w-full overflow-hidden pt-20 pb-28 md:pt-24 lg:pb-44 bg-[#000000] px-6 md:px-16">
        <div className="absolute inset-0 z-0 bg-[#000000]" aria-hidden="true">
          <img src="/speakers/Vumile Msweli/Dr-Vumile-Msweli-The-Speakers-Firm.jpg" alt="" className="absolute inset-0 h-full w-full object-cover object-center" />
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-10rem)] max-w-[1440px] flex-col justify-end pb-12 md:justify-center md:pb-0 px-6 md:px-16">
          ...
          <h1 className="text-[clamp(2.5rem,8vw,5.5rem)] font-bold uppercase leading-[0.95] tracking-[-0.055em] text-[#ffffff] drop-shadow-[0_8px_34px_rgba(0,0,0,0.38)] mt-6">
            ...
            <span className="text-[#e30e04]">WORK.</span>
          </h1>
          ...
          <div className="mt-8 flex max-w-[650px] flex-col gap-4">
            <p className="text-[16px] font-normal leading-[1.65] text-[#ffffff]/80 drop-shadow-[0_6px_22px_rgba(0,0,0,0.45)] md:text-[18px]">
              Preparing Organisations for Rapid Transformation.
            </p>
            <p className="text-sm leading-6 text-white/60">
              Leading authorities preparing organisations and people for rapidly changing technologies, skills requirements, employee expectations and workplace models.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-6 md:px-16">
          <blockquote className="m-0">
            ...
            <p className="mt-2 max-w-[800px] text-base italic leading-8 text-[#f8f7f5]/85 sm:text-lg">
              Within 24 hours, The Speakers Firm presented a carefully curated shortlist aligned with our strategy, audience, budget and brand. Their speed never compromised quality or relevance. Brief them today and accelerate your talent-booking decision.
            </p>
