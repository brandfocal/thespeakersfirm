        ...
        <div className="mx-auto max-w-[1440px] px-6 md:px-16 relative z-30">
          <div className="mb-10 text-center">
            ...
            <h1 className="text-[clamp(2.5rem,7vw,4.5rem)] font-bold uppercase leading-none tracking-[-0.05em] mt-6">
              Brief Us <span className="text-[#e30e04]">Now</span>
            </h1>
          ...
          {isSubmitted ? (
            <div className="mx-auto max-w-2xl rounded-2xl border border-[#1E1E1E] bg-[#111111] p-8 text-center text-white shadow-2xl">
              ...
              <h3 className="text-xl font-bold uppercase">Brief Submitted Successfully</h3>
              <p className="mt-4 text-[#9A9A9A] text-sm leading-relaxed">
                Thank you for briefing The Speakers Firm™.
              </p>
              ...
              <p className="text-[#9A9A9A] text-sm leading-relaxed text-left max-w-md mx-auto">
                ...
                <br /><br />
                <span className="text-xs text-[#FFFFFF]/70 italic">Please note that submitting a brief does not reserve or confirm any speakers. All bookings remain subject to availability, written confirmation and fulfilment of our commercial terms.</span>
              </p>
              <button 
                onClick={() => {
                  setStep(1);
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        <span className="text-xs text-[#9A9A9A]">I confirm that all details provided in this brief are accurate.*</span>
                      </label>
                      ...
                      <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        <span className="text-xs text-[#9A9A9A]">I understand that submitting this brief does not reserve or confirm any speakers.*</span>
                      </label>
