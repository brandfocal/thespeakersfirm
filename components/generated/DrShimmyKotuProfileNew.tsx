...
const FULL_BIO_PARAGRAPHS = [
  ...
  "Book Dr. Shimmy Kotu through The Speakers Firm, A Leading African Speakers Bureau, for your next men’s conference, leadership strategy session, or mental wellness retreat, and inspire your teams to lead with authenticity, courage, and faith."
];
