...
export function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="ml-auto hidden items-center gap-3 lg:ml-0 lg:flex relative">
        ...
        <div className="absolute -top-6 right-2 flex items-center gap-3 whitespace-nowrap">
          ...
          <a 
            href="https://wa.me/27114827256" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="flex items-center gap-1.5 rounded-full bg-white border border-[#C7C7C8]/40 px-2.5 py-0.5 text-[8.5px] font-bold tracking-wider text-[#212121] shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:text-[#25D366] transition-colors"
          >
            <svg className="w-3 h-3 fill-[#25D366]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <ArrowUpRight aria-hidden="true" className={cn("h-4 w-4 transition-transform", isActive ? "text-[#e30e04] translate-x-0.5 -translate-y-0.5" : "text-[#212121]/45")} />
                  </Link>
                );
              })}
