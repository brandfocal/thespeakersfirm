    ...
    <div className="fixed top-4 left-0 right-0 z-50 flex items-center justify-center gap-3 pointer-events-none md:top-6">
      ...
      <div className="ml-auto hidden items-center gap-3 lg:ml-0 lg:flex relative">
        ...
        <a 
          ...
          className="absolute -top-6 right-2 flex items-center gap-1.5 rounded-full bg-white border border-[#C7C7C8]/40 px-2.5 py-0.5 text-[8.5px] font-bold tracking-wider text-[#212121] shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:text-[#25D366] transition-colors whitespace-nowrap"
        >
